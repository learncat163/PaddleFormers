...
# 原始代码: from transformers import PretrainedConfig
...
class OpenELMConfig(PretrainedConfig):
    ...
    def num_hidden_layers(self) -> int:
        """Alias for num_transformer_layers, needed by DynamicCache and other utilities.

        原始代码: 使用 num_transformer_layers
        迁移说明: paddleformers 的 DynamicCache 等工具需要 num_hidden_layers 属性
        """
